...
START_TEST(test_map_add_char_many) {
  map_t *map;
  int a = 1, b = 2, c = 3, d = 4;
...
START_TEST(test_map_get_char_many) {
  map_t *map;
  int a = 1, b = 2, c = 3, d = 4;
...
Suite *map_suite(void) {
  Suite *s;
  TCase *tc_core, *tc_string, *tc_char;
  ...
  tcase_add_test(tc_char, test_map_add_char);
  tcase_add_test(tc_char, test_map_add_char_many);
  tcase_add_test(tc_char, test_map_get_char);
  tcase_add_test(tc_char, test_map_get_char_many);
